        ...
        {locations.length === 0 ? (
          ...
          <div className="workshops-grid">
            {locations.map((p) => {
              ...
              return (
                <a key={p.id} href={`/people/${p.id}?role=location`} className="ws-card">
                  <div className="ws-cover" style={{ backgroundImage: `url('${p.role_media?.location?.cover || p.photos?.[0]?.url || p.photo}')` }}>
