        ...
        {photographers.length === 0 ? (
          ...
          <div className="workshops-grid">
            {photographers.map((p) => {
              ...
              return (
                <a key={p.id} href={`/people/${p.id}?role=photographer`} className="ws-card">
                  <div className="ws-cover" style={{ backgroundImage: `url('${p.role_media?.photographer?.cover || p.photos?.[0]?.url || p.photo}')` }}>
